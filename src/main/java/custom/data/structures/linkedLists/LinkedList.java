...
public class LinkedList<T> {
   ...
   * @throws IllegalArgumentException when value is null
   */
  public LinkedList<T> insertAtBeginning(LinkedList<T> head, T value) {
   ...
   * @throws IllegalArgumentException when value is null
   */
  public LinkedList<T> insertAtEnd(LinkedList<T> head, T value) {
    ...
    LinkedList<T> newNode = new LinkedList<>(value);
    LinkedList<T> temporaryNode = head;
   ...
   */
  public LinkedList<T> insertAtIndex(LinkedList<T> head, T value, int index) {
    ...
    int counter = 0;
    LinkedList<T> previousNode = head;
   ...
   */
  public void printIterative(LinkedList<T> head) {
   ...
   * @param head head node of the list
   */
  public void printRecursive(LinkedList<T> head) {
   ...
   */
  public LinkedList<T> deleteByValue(LinkedList<T> head, T value) {
   ...
   */
  public LinkedList<T> deleteFromEnd(LinkedList<T> head) {
   ...
   * @throws IllegalArgumentException when head is null
   */
  public LinkedList<T> deleteFromBeginning(LinkedList<T> head) {
    ...
    // Case 2: Remove head and return the next node
    return head.next;
  }
   ...
   * @throws IndexOutOfBoundsException when index is invalid
   */
  public LinkedList<T> deleteAtIndex(LinkedList<T> head, T value, int index) {
   ...
   */
  public LinkedList<T> reverse(LinkedList<T> head) {

    LinkedList<T> previousNode = null;
    LinkedList<T> currentNode = head;

    while (currentNode != null) {
      LinkedList<T> nextNode = currentNode.next;
